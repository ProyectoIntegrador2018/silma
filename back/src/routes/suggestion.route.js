...
export const addSuggestionRoutes = (router) => {
  ...
  router.get(
    "/suggestions/getReadersWithoutSuggestion/:id",
    verifyToken(["admin"]),
    getReadersWithoutSuggestion
  );
  router.get(
    "/suggestions/getAllSuggestions/:id",
    verifyToken(["admin", "reader"]),
    getAllSuggestionsFromReader
  );
  router.get(
    "/suggestions/getSuggestionDashboard/:id",
    verifyToken(["reader"]),
    getSuggestionFromReaderDashboard
  );
  router.get(
    "/suggestions/getAllSuggestionsDashboard/:id",
    verifyToken(["reader"]),
    getAllSuggestionsFromReaderDashboard
  );
  router.get(
    "/suggestions/getTextSuggestions/:id",
    verifyToken(["admin"]),
    getTextSuggestions
  );
  router.get(
  ...
  router.post(
    "/suggestions/:id/requestChapters",
    verifyToken(["reader"]),
    changeReadingChapters
  );
};
